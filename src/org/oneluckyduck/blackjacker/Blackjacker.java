...
@Manifest(authors = { "OneLuckyDuck" }, name = "Thieves Guild Blackjacking", description = "Knocks that fatass on his fat ass.", version = 1.0)
public class Blackjacker extends ActiveScript implements PaintListener,
	...
	public void onStop() {
		Environment.saveScreenCapture("99");
	}
